...
def eclipse_new_dawn_for_the_galaxy_rules(supa_client, supa_key, config):
    rules_file = web_downloader(config.get('Sources', 'eclipse_new_dawn_for_the_galaxy_rules'),
    ...
    supa_trainer("eclipse_new_dawn_for_the_galaxy_rules", "Eclipse New Dawn for the Galaxy",
